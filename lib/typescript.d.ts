...
declare namespace ts {
    ...
    enum SyntaxKind {
        ...
        DeferStatement = 263,
        VariableDeclaration = 264,
        VariableDeclarationList = 265,
        FunctionDeclaration = 266,
        ClassDeclaration = 267,
        InterfaceDeclaration = 268,
        TypeAliasDeclaration = 269,
        EnumDeclaration = 270,
        ModuleDeclaration = 271,
        ModuleBlock = 272,
        CaseBlock = 273,
        NamespaceExportDeclaration = 274,
        ImportEqualsDeclaration = 275,
        ImportDeclaration = 276,
        ImportClause = 277,
        NamespaceImport = 278,
        NamedImports = 279,
        ImportSpecifier = 280,
        ExportAssignment = 281,
        ExportDeclaration = 282,
        NamedExports = 283,
        NamespaceExport = 284,
        ExportSpecifier = 285,
        MissingDeclaration = 286,
        ExternalModuleReference = 287,
        JsxElement = 288,
        JsxSelfClosingElement = 289,
        JsxOpeningElement = 290,
        JsxClosingElement = 291,
        JsxFragment = 292,
        JsxOpeningFragment = 293,
        JsxClosingFragment = 294,
        JsxAttribute = 295,
        JsxAttributes = 296,
        JsxSpreadAttribute = 297,
        JsxExpression = 298,
        JsxNamespacedName = 299,
        CaseClause = 300,
        DefaultClause = 301,
        HeritageClause = 302,
        CatchClause = 303,
        ImportAttributes = 304,
        ImportAttribute = 305,
        /** @deprecated */ AssertClause = 304,
        /** @deprecated */ AssertEntry = 305,
        /** @deprecated */ ImportTypeAssertionContainer = 306,
        PropertyAssignment = 307,
        ShorthandPropertyAssignment = 308,
        SpreadAssignment = 309,
        EnumMember = 310,
        SourceFile = 311,
        Bundle = 312,
