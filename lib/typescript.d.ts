...
declare namespace ts {
    ...
    enum SyntaxKind {
        ...
        IsExpression = 243,
        TemplateSpan = 244,
        SemicolonClassElement = 245,
        Block = 246,
        EmptyStatement = 247,
        VariableStatement = 248,
        ExpressionStatement = 249,
        IfStatement = 250,
        DoStatement = 251,
        WhileStatement = 252,
        ForStatement = 253,
        ForInStatement = 254,
        ForOfStatement = 255,
        ContinueStatement = 256,
        BreakStatement = 257,
        ReturnStatement = 258,
        WithStatement = 259,
        SwitchStatement = 260,
        LabeledStatement = 261,
        ThrowStatement = 262,
        TryStatement = 263,
        DebuggerStatement = 264,
        FallthroughStatement = 265,
        DeferStatement = 266,
        VariableDeclaration = 267,
        VariableDeclarationList = 268,
        FunctionDeclaration = 269,
        ClassDeclaration = 270,
        InterfaceDeclaration = 271,
        TypeAliasDeclaration = 272,
        EnumDeclaration = 273,
        ModuleDeclaration = 274,
        ModuleBlock = 275,
        CaseBlock = 276,
        NamespaceExportDeclaration = 277,
        ImportEqualsDeclaration = 278,
        ImportDeclaration = 279,
        ImportClause = 280,
        NamespaceImport = 281,
        NamedImports = 282,
        ImportSpecifier = 283,
        ExportAssignment = 284,
        ExportDeclaration = 285,
        NamedExports = 286,
        NamespaceExport = 287,
        ExportSpecifier = 288,
        MissingDeclaration = 289,
        ExternalModuleReference = 290,
        JsxElement = 291,
        JsxSelfClosingElement = 292,
        JsxOpeningElement = 293,
        JsxClosingElement = 294,
        JsxFragment = 295,
        JsxOpeningFragment = 296,
        JsxClosingFragment = 297,
        JsxAttribute = 298,
        JsxAttributes = 299,
        JsxSpreadAttribute = 300,
        JsxExpression = 301,
