...
export function createGetIsolatedDeclarationErrors(resolver: EmitResolver): (node: Node) => DiagnosticWithLocation {
    const relatedSuggestionByDeclarationKind = {
        ...
        [SyntaxKind.JsxMethodAttribute]: Diagnostics.Add_a_return_type_to_the_method,
    ...
    const errorByDeclarationKind = {
        ...
        [SyntaxKind.JsxMethodAttribute]: Diagnostics.Method_must_have_an_explicit_return_type_annotation_with_isolatedDeclarations,
